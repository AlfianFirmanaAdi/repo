...
st.markdown(
    ...
    .stButton>button {
        ...
        width: 100%; /* Agar tombol mengisi kolomnya */
    }
    ...
    .stButton[data-testid*="stButton-confirm_delete"] > button { /* Menggunakan * untuk key dinamis */
    ...
    .stButton[data-testid*="stButton-toggle_delete_mode"] > button {
        background-color: #dc3545; /* Merah untuk Pilih Hapus */
    }
...
if not image_files:
    ...
    # Mengatur tata letak tombol-tombol utama (Pilih Hapus / Batal Hapus dan Hapus Terpilih)
    col_mode_btn, col_delete_confirm_btn, _ = st.columns([0.15, 0.25, 0.6]) # Kolom untuk tombol mode, tombol konfirmasi, dan ruang kosong
    ...
    # Menampilkan pesan peringatan mode hapus jika aktif tapi belum ada foto terpilih
    if st.session_state.delete_mode and not st.session_state.selected_for_delete:
